...
precision_obvious_baseline <- read.table("./obvious_precision_baseline_noncumulative_20.dat", header=FALSE, sep=";")
...
precision_obvious_stash <- read.table("./obvious_precision_stash_noncumulative_20.dat", header=FALSE, sep=";")
...
recall_obvious_baseline <- read.table("./obvious_recall_baseline_noncumulative_20.dat", header=FALSE, sep=";")
...
recall_obvious_stash <- read.table("./obvious_recall_stash_noncumulative_20.dat", header=FALSE, sep=";")
...
plot(recall_relevant$intent, type="l", col=plot_colors[1], 
     ylim=c(0, 0.01), axes=F, ann=T, xlab="Time (s)",
...
f1_obvious_baseline <- read.table("./obvious_f1_baseline_noncumulative_20.dat", header=FALSE, sep=";")
...
f1_obvious_stash <- read.table("./obvious_f1_stash_noncumulative_20.dat", header=FALSE, sep=";")
