...
precision_relevant_baseline <- read.table("./relevant_precision_baseline_20.dat", header=FALSE, sep=";")
...
precision_relevant_stash <- read.table("./relevant_precision_stash_20.dat", header=FALSE, sep=";")
...
recall_relevant_baseline <- read.table("./relevant_recall_baseline_20.dat", header=FALSE, sep=";")
...
recall_relevant_stash <- read.table("./relevant_recall_stash_20.dat", header=FALSE, sep=";")
...
plot(recall_relevant$intent, type="l", col=plot_colors[1], 
     ylim=c(0, 0.1), axes=F, ann=T, xlab="Time (s)",
...
f1_relevant_baseline <- read.table("./relevant_f1_baseline_20.dat", header=FALSE, sep=";")
...
f1_relevant_stash <- read.table("./relevant_f1_stash_20.dat", header=FALSE, sep=";")
...
plot(f1_relevant$intent, type="l", col=plot_colors[1], 
     ylim=c(0, 0.3), axes=F, ann=T, xlab="Time (s)",
