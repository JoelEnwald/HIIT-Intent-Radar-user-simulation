Simulate users using a search engine that retrieves documents for typed queries and clicked keywords. Collect and plot the resulting data from the user agents.
